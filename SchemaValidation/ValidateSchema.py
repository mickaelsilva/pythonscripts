...
def main():
	...
	with open("./resultsHTML/"+genebasename+"_results.html", "wb") as f:
		f.write("<!DOCTYPE html>\n<html>\n<head><script type='text/javascript' src='https://raw.githubusercontent.com/mbostock/d3/master/d3.min.js'></script><script type='text/javascript' src='https://mpld3.github.io/js/mpld3.v0.2.js'></script>\n<title>Schema Validation Results</title>\n</head>\n<body>\n<h1>Allele CDS analysis results</h1>\n")
